...
def move2pos(arm, x, y, z, plus=True):
    ...
    ikResults = armChain.inverse_kinematics([tx - 0.05, ty + 0.03, tz + 0.02])
...
# while supervisor.step(timeStep) != -1:
    ...
    # if targets:
        # for target in targets:
            ...
            # x = distance * math.cos(theta - 1.57)
            # y = 0.66
            # z = distance * math.sin(theta - 1.57)
        # break
